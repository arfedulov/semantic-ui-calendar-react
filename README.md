...
| ``dots`` | {object[]} List of dates which will have dots in their cell or box. Object must have `dates` (Date[] | moment[]) and `color` (string). Color must be one of the Semantic UI colors |
